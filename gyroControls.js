...
export function createGyroControls(camera, domElement) {
  ...
  // Adjust rotation according to phone rotation
  ...
  domElement.addEventListener("touchstart", (e) => {
    ...
    if (touch.clientX < rect.width / 3)   keys.left = true;
    else if (touch.clientX > 2 * rect.width / 3)   keys.right = true;
  ...
  function update() {
    ...
    // left and right should increase or decrease yaw, in addition to the device orientation
