...
class Simulation {
  constructor() {
    ...
    this.world.setWorldType("DESERT");
  ...
  createUI() {
    ...
    mapSelect.addEventListener("change", (e) => {
      ...
      console.log("selected world:", type);
      this.world.setWorldType(type);
    });
    ...
    vehiculeSelect.addEventListener("change", (e) => {
      const type = e.target.value;
      console.log("selected vehicule:", type);
      this.player.setVehiculeType(type)
    });
  ...
  animate() {
    ...
    // Update game
    this.world.chunkManager.updateCurvature(this.camera); // update curvature based on camera.pos
